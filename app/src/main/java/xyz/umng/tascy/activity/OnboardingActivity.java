...
public class OnboardingActivity extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        int[] bgs = new int[]{R.drawable.fridge, R.drawable.honey, R.drawable.deliver};
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            TextView textView2 = (TextView) rootView.findViewById(R.id.section_description);
            String tempTitle, tempDetails;
            switch (getArguments().getInt(ARG_SECTION_NUMBER))
            {
                case 1:
                    tempTitle = "Durable Food";
                    tempDetails = "Get healthy and durable food from all the way around India at your door steps.";
                    break;
                case 2:
                    tempTitle = "2";
                    tempDetails = "two";
                ...
                default:
                    tempTitle = "Tascy";
                    tempDetails = "We got a bug, Please let us know about this.";
                    break;
            }
            textView.setText(getString(R.string.section_format, tempTitle));
            textView2.setText(getString(R.string.section_format, tempDetails));
